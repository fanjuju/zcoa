...
class SupplierMaterialTestProcess(Base):
    # 点击我的审核tap栏
    def page_click_my_process(self):
        self.base_click(page.page_click_my_process)

    # 点击试方试料审核
    def page_click_materialtest_process(self):
        self.base_click(page.page_materialtest_button)
    ...
    # 开发联系单办理审核流程
    def page_supplier_materialtest(self,name,value):
        self.page_click_my_process()
        time.sleep(2)
        self.page_click_materialtest_process()
        time.sleep(1)
